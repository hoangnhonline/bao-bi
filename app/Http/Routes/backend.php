...
Route::get('admin/login', ['as' => 'backend.login-form', 'uses' => 'Backend\UserController@loginForm']);
Route::post('admin/login', ['as' => 'backend.check-login', 'uses' => 'Backend\UserController@checkLogin']);
Route::get('admin/logout', ['as' => 'backend.logout', 'uses' => 'Backend\UserController@logout']);
